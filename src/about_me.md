...
- 알레르기가 있어 멀리하게 된 것들
  - 사과, 복숭아 등 몇몇 음식에 [구강 알레르기](https://yoonbh2714.blogspot.com/2014/12/blog-post_16.html)가 있다. 아예 못 먹는 건 아닌데 가끔 심할 때가 있어 조심하는 편이다.
...
- [INFP(2007년) -> INFP(2009년) -> INFP(2016년) -> INFJ(2018년)](https://yoonbh2714.blogspot.com/2009/11/mbti.html), 약간 변하긴 했지만, 내성적(I), 직관적(N), 느낌적(F), 판단적(J)이라는데, 나서길 좋아하지 않고 혼자 있는 시간이 편하고 느낌 가는 대로 생각하는 성향인 것 같다.
...
- `not everything does, not everything has to` 영화 '닥터스트레인지'에서 [ancient one 이 했던 말](https://yoonbh2714.blogspot.com/2018/09/i-like-doctor-strange.html)이다. 틀에 얽매이지 말고 관습에 묶이지 말고 유연하게 말랑말한 생각으로 살고 싶다. 둘이 했던 영어 대화가 너무 좋아 외우고 가끔 혼자 주절거린다.
