...
export function loadProgramList() {
    ...
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/installcommon.sh')
        ...
        .then(function () {});
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/installbrew.sh')
        .then(function (response) {
        ...
        .then(function () {});
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/installcargo.sh')
        .then(function (response) {
            let data = response.data.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        .then(function () {});
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/installpip.sh')
        .then(function (response) {
            let data = response.data.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        .then(function () {});
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/.vimrc')
        .then(function (response) {
        ...
        .then(function () {});
    axios.get('https://raw.githubusercontent.com/ysoftman/myenv/master/installvscodeextension.sh')
        .then(function (response) {
            let data = response.data.replace(/(?:\r\n|\r|\n)/g, '<br>');
